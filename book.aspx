<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="book.aspx.cs" Inherits="mutle.WebForm6" %>
...
.product.product__style--3 .product__thumb {
  ...
  .product.product__style--3 .product__thumb .action .actions_inner .add_to_links li a.cart {
    background: #ebebeb url("images/icons/cart2.png") no-repeat ; }
    .product.product__style--3 .product__thumb .action .actions_inner .add_to_links li a.cart:hover {
      background-color: #ce7852;
      background-position: 100% 0;
      transition: all 300ms ease-in 0s; }
  .product.product__style--3 .product__thumb .action .actions_inner .add_to_links li a.wishlist {
    background: #ebebeb url("images/icons/wishlist2.png") no-repeat ; }
    .product.product__style--3 .product__thumb .action .actions_inner .add_to_links li a.wishlist:hover {
      background-color: #ce7852;
      background-position: 100% 0;
      transition: all 300ms ease-in 0s; }
  .product.product__style--3 .product__thumb .action .actions_inner .add_to_links li a.compare {
    background: #ebebeb url("images/icons/compare2.png") no-repeat ; }
    .product.product__style--3 .product__thumb .action .actions_inner .add_to_links li a.compare:hover {
      background-color: #ce7852;
      background-position: 100% 0;
      transition: all 300ms ease-in 0s; }
  .product.product__style--3 .product__thumb .action .actions_inner .add_to_links li a.quickview {
    background: #ebebeb url("images/icons/search2.png") no-repeat ; }
...
.product-info .select__color .color__list {
  ...
  .product-info .select__color .color__list li.gold a {
    background: #cc9900 none repeat ; }
  .product-info .select__color .color__list li.orange a {
    background: #cc6600 none repeat  ; }
...
.hero {
  ...
  box-sizing: border-box;
  color: white; 
  background: url(imgs/lala.JPG) center center no-repeat;
  background-size: cover;
}
        			...
        			<div class="col-lg-3 col-12 order-2 order-lg-1 md-mt-40 sm-mt-40">
        				<div class="shop__sidebar">
        					...
        					<aside class="wedget__categories sidebar--banner">
								<img src="https://images.pexels.com/photos/5608541/pexels-photo-5608541.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="banner images">
								<div class="text">
									<h2>new products</h2>
	        				...
	        				<div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
	        					<div class="row">
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="book1.aspx"><img src="imgs/booke.png" alt="product image"></a>
			        							<a class="second__img animation1" href="book1.aspx"><img src="imgs/booke.png" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">حصري </span>
			        							</div>
			        						...
			        						<center>	<h4><a href="book1.aspx">أدب الأطفال </a></h4></center>
			        							<ul class="rating d-flex"  style="list-style-type: none;">
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="book3.aspx"><img src="imgs/book7.png" alt="product image"></a>
			        							<a class="second__img animation1" href="book3.aspx"><img src="imgs/book7.png" alt="product image"></a>
			        							<div class="new__box">
			        						...
			        						<div class="product__content">
			        						<center><h4><a href="book3.aspx">علم التشفير </a></h4></center>	
			        							<ul class="rating d-flex"  style="list-style-type: none;" >
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="book2.aspx"><img src="imgs/book10.png" alt="product image"></a>
			        							<a class="second__img animation1" href="book2.aspx"><img src="imgs/book10.png" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">حصري</span>
			        							</div>
			        							<ul class="prize position__right__bottom d-flex">
			        						...
			        						<div class="product__content">
			        						<center><h4><a href="book2.aspx">الخيال العلمي </a></h4> </center>	
			        							<ul class="rating d-flex"  style="list-style-type: none;" >
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.html"><img src="imgs/book12.png" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.html"><img src="imgs/book12.png" alt="product image"></a>
			        							<ul class="prize position__right__bottom d-flex">
			        						...
			        						<div class="product__content">
			        					<center>		<h4><a href="single-product.html">علم الاحصاء </a></h4> </center>
			        							<ul class="rating d-flex"  style="list-style-type: none;">
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.html"><img src="imgs/book8.png" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.html"><img src="imgs/book8.png" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">حصري</span>
			        							</div>
			        						...
			        						<div class="product__content">
			        					<center>		<h4><a href="single-product.html">نظرية الفوضى</a></h4> </center>
			        							<ul class="rating d-flex"  style="list-style-type: none;" >
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.html"><img src="imgs/bookd.png" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.html"><img src="imgs/bookd.png" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">حصري</span>
			        							</div>
			        							
			        							<div class="action">
			        								<div class="actions_inner"  style="list-style-type: none;">
			        						...
			        						<div class="product__content">
			        						<center><h4><a href="single-product.html">السحر</a></h4> </center>	
			        							<ul class="rating d-flex"  style="list-style-type: none;" >
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.html"><img src="imgs/book9.png" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.html"><img src="imgs/book9.png" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">جديد</span>
			        							</div>
			        						...
			        						<div class="product__content">
			        					<center>		<h4><a href="single-product.html">الديناصورات </a></h4> </center>
			        							<ul class="rating d-flex"  style="list-style-type: none;">
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.html"><img src="imgs/book6.png" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.html"><img src="imgs/book6.png" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">جديد</span>
			        							</div>
			        						...
			        						<div class="product__content">
			        					<center>	<h4><a href="single-product.html">نيوتن</a></h4> </center>	
			        							<ul class="rating d-flex"  style="list-style-type: none;">
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
		        					...
		        					<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product">
			        						<div class="product__thumb">
			        							<a class="first__img" href="single-product.html"><img src="imgs/booka.png" alt="product image"></a>
			        							<a class="second__img animation1" href="single-product.html"><img src="imgs/booka.png" alt="product image"></a>
			        							<div class="new__box">
			        								<span class="new-label">حصرية</span>
			        							</div>
			        					...
			        					<center><div class="product__content">
			        							 <h4><a href="single-product.html">نظرية الألعاب</a></h4>
			        						<center>	<ul class="rating d-flex"  style="list-style-type: none;" >
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li class="on"><i class="fa fa-star-o"></i></li>
			        								<li><i class="fa fa-star-o"></i></li>
