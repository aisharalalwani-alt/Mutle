<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="book1.aspx.cs" Inherits="mutle.WebForm8" %>
  ...
  <div class="wrapper">
    ...
    <div class="product-info">
      <div class="product-text">
        ...
        <button  formaction="reed.aspx" >RAED</button> 
       
          <button formaction="adi.aspx" style="margin:2px 100px 2px 2px;">Listen</button>
      </div>
  </div>
      </body>
